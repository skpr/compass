...
func BenchmarkDecodeFunctionEventPath(b *testing.B) {
	...
	copy(rawSample[1:102], "Drupal\\Core\\Entity\\Sql\\SqlContentEntityStorage::loadMultiple")
	binary.LittleEndian.PutUint64(rawSample[104:112], 4242)
	binary.LittleEndian.PutUint64(rawSample[112:120], 1700000000)
	binary.LittleEndian.PutUint64(rawSample[120:128], 5000)
	binary.LittleEndian.PutUint64(rawSample[128:136], 1<<20)
